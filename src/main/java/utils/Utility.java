...
public class Utility {
	...
	public void browserLaunchandURL() throws IOException  {
		...
		FileReader reader = new FileReader("C:\\Users\\Anbu Rose\\eclipse-workspace\\capstone_SpiceJet\\src\\main\\resources\\Testdata.properties");
		//read the properties
	...
	public String takeScreenshot(String screenshotName) throws IOException {
		...
		String path ="C:\\Users\\Anbu Rose\\eclipse-workspace\\capstone_SpiceJet\\screenshot\\"+screenshotTitle+".png";
	...
	public String[][] readExcel(String excelFile) throws IOException {
		XSSFWorkbook book = new XSSFWorkbook("C:\\Users\\Anbu Rose\\eclipse-workspace\\capstone_SpiceJet\\data\\"+excelFile+".xlsx");
