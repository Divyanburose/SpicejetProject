...
public class SignupPage extends ProjectSpecificationMethod {
    ...
    public SignupPage firstName() {
    	driver.findElement(By.xpath("//input[@id=\"first_name\"]")).sendKeys("Divya");
    	return this;
    }

    public SignupPage lastName() {
    	driver.findElement(By.xpath("//input[@id=\"last_name\"]")).sendKeys("Anburose");
    	return this;
    }
    ...
    public SignupPage dateOfBirth() {
    	...
    	driver.findElement(By.xpath("//div[@aria-label=\"Choose Thursday, October 26th, 1995\"]")).click();
    	return this;
    }
    
    public SignupPage mobileNum() {
    	driver.findElement(By.xpath("//input[@type=\"tel\"]")).sendKeys("7200965967");
    	return this;
    	
    }

    public SignupPage email() {
    	driver.findElement(By.xpath("//input[@id=\"email_id\"]")).sendKeys("divyaganeshwathi@gmail.com");
    	return this;
    }

    public SignupPage password() {
    	driver.findElement(By.xpath("id=\"new-password\"")).sendKeys("divy@123");
    	return this;
    }

    public SignupPage confirmPassword() {
    	driver.findElement(By.xpath("//input[@id=\"c-password\"]")).sendKeys("divy@123");
    	return this;
    }
